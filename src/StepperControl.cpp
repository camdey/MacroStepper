...
void TMC5160Stepper_Ext::photo360() {
    // targetVelocity(360); // approx. 5rpm
    ...
    //     if (getCurrentStage() == pullShutter && reachedTarget()) {
    ...
    //         if (millis() - camera.lastFlashMillis() >= 800) {
